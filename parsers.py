...
import argparse
from snip.envs import ENVS
from snip.utils import bool_flag
...
def get_parser():
    ...
    parser.add_argument(
        "--property_type", type=str, default="ncr", help="Type of the numeric property defined for the cross-modal property prediction: ncr,upward,yavg,oscil"
    )
    
    parser.add_argument(
        "--is_proppred", type=bool, default=False, help="Boolean Parameter to control pretraining vs. property prediction tasks"
    )
